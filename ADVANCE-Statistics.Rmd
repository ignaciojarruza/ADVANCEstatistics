...
for (file in excel_files) {
  ...
  #attendance_list[[topic_table]] <- attendance_data
}

# print(excel_files)
# lapply(excel_files, function(x) {
#   attendance_data <- read_excel(x)
#   head(attendance_data)
#   topic_table <- read_excel(x, range = "A1:G2")
#   attendance_data <- attendance_data[-c(0:3), -c(2:7)]
#   colnames(attendance_data)[1] <- "Names"
